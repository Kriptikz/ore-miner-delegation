...
use ore_miner_delegation::{
    global_boost::{self, GLOBAL_BOOST_ID}, pda::{delegated_boost_pda, delegated_boost_v2_pda, delegated_stake_pda, managed_proof_pda}, utils::AccountDeserialize as _
};
...
//     let ix = ore_miner_delegation::instruction::mine_with_boost(miner.pubkey(), BUS_ADDRESSES[0], solution, vec![boost_account.0, boost_stake.0]);
